...
function typescript(options) {
    ...
    return {
        ...
        options() {
            parsedConfig = (0, parse_tsconfig_1.parseTsConfig)(pluginOptions.tsconfig, pluginOptions.tsconfigOverride, emitDiagnostics, pluginOptions.tsconfigSearchPath);
            filter = (0, pluginutils_1.createFilter)(pluginOptions.include, pluginOptions.exclude);
        ...
        resolveId(importee, importer) {
            ...
            if (!importer)
                return;
            const result = typescript_1.default.nodeModuleNameResolver(importee, (0, pathUtils_1.normalizeToPOSIX)(importer), parsedConfig.options, typescript_1.default.sys);
