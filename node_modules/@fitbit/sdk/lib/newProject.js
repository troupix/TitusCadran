...
async function newProject() {
    ...
    const config = (0, ProjectConfiguration_1.normalizeProjectConfig)(packageJSON);
    ...
    scaffoldDirectory('resources', (0, sdkVersion_1.default)().major < 5 ? 'resources_4.x' : undefined);
