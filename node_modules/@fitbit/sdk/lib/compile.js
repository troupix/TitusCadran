...
function compile({ component, entryPoint, outputDir, defaultLanguage, allowUnknownExternals = false, onDiagnostic = diagnostics_1.logDiagnosticToConsole, }) {
    ...
    return (0, rollupToVinyl_1.default)({
        input: entryPoint,
        plugins: [
            ...pluginIf(component !== componentTargets_1.ComponentType.DEVICE, () => (0, polyfill_1.default)((0, i18nPolyfill_1.default)(translationsGlob, defaultLanguage))),
            ...pluginIf(component === componentTargets_1.ComponentType.COMPANION &&
                semver_1.default.satisfies((0, sdkVersion_1.default)(), '~6.0.0'), () => (0, polyfill_1.default)(weatherPolyfill_1.default)),
            platformExternals.plugin(component),
            (0, typescript_2.default)({
                onDiagnostic,
            ...
            (0, forbidAbsoluteImport_1.default)(),
            (0, plugin_node_resolve_1.default)({ preferBuiltins: false }),
            (0, plugin_commonjs_1.default)({ include: ['node_modules/**'] }),
            ...pluginIf(ecma === 5, () => (0, plugin_babel_1.default)({
                plugins: [
            ...
            (0, workaroundRequireScope_1.default)(),
            (0, terser_1.default)({
                ecma,
        ...
        onwarn: (0, rollupWarningHandler_1.default)({
            onDiagnostic,
        ...
        interop: (id) => {
            ...
            if (component === componentTargets_1.ComponentType.DEVICE &&
                ...
                (0, sdkVersion_1.default)().major < 6) {
                return 'auto';
            }
            return 'esModule';
        },
