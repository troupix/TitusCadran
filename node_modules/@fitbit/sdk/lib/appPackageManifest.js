...
function getBundleInfo(file) {
    return (0, function_1.pipe)(ComponentBundleTag.decode(file.componentBundle), (0, Either_1.fold)((errors) => {
        throw new plugin_error_1.default(PLUGIN_NAME, `Unknown bundle component tag: ${(0, PathReporter_1.failure)(errors).join('\n')}`, { fileName: file.relative });
    }, (tag) => tag));
}
class AppPackageManifestTransform extends stream_1.Transform {
    ...
    _transform(file, _, next) {
        if (file.componentMapKey) {
            lodash_1.default.merge(this.sourceMaps, lodash_1.default.set({}, file.componentMapKey, (0, pathUtils_1.normalizeToPOSIX)(file.relative)));
        }
    ...
    _flush(callback) {
        ...
        const { deviceApi, companionApi } = (0, sdkVersion_1.apiVersions)(this.projectConfig);
