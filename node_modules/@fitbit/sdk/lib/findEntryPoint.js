...
function findEntryPoint(possibilities, options) {
    ...
    if (foundEntryPoints.length === 1)
        ...
        const possibilitiesStr = (0, humanize_list_1.default)(possibilities, { conjunction: 'or' });
        if (notFoundIsFatal) {
        ...
        throw new BuildError_1.default(`Multiple ${component} entry points found! ${(0, humanize_list_1.default)(foundEntryPoints)} are all valid entry points; rename all but one and try again.`);
    }
    return entryPoint;
}
