...
function makeDeviceManifest({ projectConfig, buildId, targetDevice, }) {
    ...
    return new stream_1.Transform({
        ...
        transform(file, _, next) {
            ...
            if (lang) {
                if (locales[lang] === undefined)
                    locales[lang] = {};
                locales[lang].resources = (0, pathUtils_1.normalizeToPOSIX)(file.relative);
            }
            if (file.isEntryPoint) {
                if (file.componentType === componentTargets_1.ComponentType.DEVICE) {
                    ...
                    entryPoint = (0, pathUtils_1.normalizeToPOSIX)(file.relative);
                }
                else {
        ...
        flush(done) {
            ...
            const { deviceApi: apiVersion } = (0, sdkVersion_1.apiVersions)(projectConfig);
    ...
    return new stream_1.Transform({
        ...
        transform(file, _, next) {
            ...
            if (isEntryPoint) {
                if (file.componentType === componentTargets_1.ComponentType.COMPANION) {
                    ...
                    companionEntryPoint = (0, pathUtils_1.normalizeToPOSIX)(file.relative);
                }
                    ...
                    settingsEntryPoint = (0, pathUtils_1.normalizeToPOSIX)(file.relative);
                }
                else {
                    return next(new plugin_error_1.default(PLUGIN_NAME, `Entry point for unrecognised component found: ${file.componentType}`));
                }
        ...
        flush(done) {
            ...
            const manifest = Object.assign({ manifestVersion: 2, companion: { main: companionEntryPoint } }, makeCommonManifest({
                projectConfig,
                buildId,
                apiVersion: (0, sdkVersion_1.apiVersions)(projectConfig).companionApi,
            }));
            if (hasSettings) {
                if (!settingsEntryPoint) {
